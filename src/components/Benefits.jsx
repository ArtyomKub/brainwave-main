                ...
                <div className="flex flex-wrap gap-10 mb-10">
                    <div className="block relative p-0.5 bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem]"
                        ...
                        <div className="absolute inset-0.5 bg-n-8" style={{clipPath: "url(#benefits)"}}>
                            <div className="absolute inset-0 opacity-0 transition-opacity hover:opacity-10">
                                <img src={"./benefits/image-2.png"} width={380} height={362}
                    ...
                    <div className="block relative p-0.5 bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem]"
                        ...
                        <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] pointer-events-none">
                            ...
                            <div className="flex items-center mt-auto">
                                <img src={"./benefits/icon-2.svg"} width={48} height={48}/>
                                {/*<p className="ml-auto font-code text-xs font-bold text-n-1 uppercase tracking-wider">*/}
                                {/*  Explore more*/}
                                {/*</p>*/}
                                {/*<Arrow/>*/}
                    ...
                    <div className="block relative p-0.5 bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem]"
                        ...
                        <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] pointer-events-none">
                            ...
                            <div className="flex items-center mt-auto">
                                <img src={"./benefits/icon-3.svg"} width={48} height={48}/>
                                {/*<p className="ml-auto font-code text-xs font-bold text-n-1 uppercase tracking-wider">*/}
                                {/*  Explore more*/}
                                {/*</p>*/}
                                {/*<Arrow/>*/}
                    ...
                    <div className="block relative p-0.5 bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem]"
                        ...
                        <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] pointer-events-none">
                            ...
                            <div className="flex items-center mt-auto">
                                <img src={"./benefits/icon-4.svg"} width={48} height={48}/>
                                {/*<p className="ml-auto font-code text-xs font-bold text-n-1 uppercase tracking-wider">*/}
                                {/*  Explore more*/}
                                {/*</p>*/}
                                {/*<Arrow/>*/}
